...
// TODO: make colour and bg work together
function styledLogs(colour, text, decorations) {
    var colour = colourReference[colour];
    var decorations = colourReference[decorations]

    const styling = decorations ? `${colour}${decorations}` : colour;
